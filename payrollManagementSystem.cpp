...
void EMPLOYEE::SALARY_SLIP() {
    ...
    cout << "\nEnter the Salary Slip date (DD MM YYYY): ";
    cin >> d.dd >> d.mm >> d.yy;

    if (!VALID_DATE(d.dd, d.mm, d.yy)) {
        cout << "Invalid date!\n";
        return;
    }
    ...
    while (!file.eof()) {
        if (code == tcode) {
            cout << "\n\n";
            cout << "================================================================\n";
            cout << "                    SALARY SLIP FOR EMPLOYEE\n";
            cout << "================================================================\n";
            cout << "Employee Code : " << code << "  Name : " << name << endl;
            cout << "Designation : " << desig << "  Grade : " << grade << endl;
            cout << "Basic Salary : " << basic << endl;
            cout << "House Rent : ";
            if (house == 'Y' || house == 'y') {
                float hra = basic * 0.3; // Assuming 30% of the basic as House Rent Allowance
                cout << hra << endl;
            } else {
                cout << "0\n";
            }
            cout << "Conveyance : ";
            if (convense == 'Y' || convense == 'y') {
                float conveyance = basic * 0.2; // Assuming 20% of the basic as Conveyance Allowance
                cout << conveyance << endl;
            } else {
                cout << "0\n";
            }
            cout << "Loan Deduction : " << loan << endl;
            cout << "----------------------------------------------------------------\n";
            float gross_salary = basic;
            if (house == 'Y' || house == 'y') {
                gross_salary += basic * 0.3;
            }
            if (convense == 'Y' || convense == 'y') {
                gross_salary += basic * 0.2;
            }
            float net_salary = gross_salary - loan;
            cout << "Gross Salary : " << gross_salary << endl;
            cout << "Net Salary : " << net_salary << endl;
            cout << "----------------------------------------------------------------\n";
            cout << "Salary Slip Date: " << d.dd << "/" << d.mm << "/" << d.yy << endl;
            cout << "================================================================\n";
